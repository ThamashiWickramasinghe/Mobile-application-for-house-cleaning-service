...
class _RepairState extends State<Repair> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Repair Services", style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
      ...
      body: Container(
        ...
        child: StreamBuilder<QuerySnapshot>(
          stream: _firestore.collection("Vacancy")
              .where("Category", isEqualTo: "Repair") // Fetch only Repair jobs
              .snapshots(),
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
              return const Center(child: Text("No repair vacancies available"));
            }
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                String ownerId = vacancies[index].id; // Pass correct owner ID
  ...
  Widget _buildRepairCard(Color cardColor, String owner, String location, String payment, String description, String ownerId) {
    return Container(
